                             ...
                             EFI_SYSTEM_TABLE *systemTable )
{
    ...
    //  get the time.
    EFI_TIME              time;
    EFI_TIME_CAPABILITIES precision;
    systemTablePointer->RuntimeServices->GetTime ( &time, &precision );
    ...
    systemTablePointer->BootServices->GetMemoryMap ( &mmapSize,
                                                     mmap,
                                                     &mmapKey,
                                                     &descriptorSize,
                                                     &descriptorVersion );
    systemTablePointer->BootServices->AllocatePool ( EfiConventionalMemory,
                                                     mmapSize,
                                                     ( VOID ** ) &mmap );
    systemTablePointer->BootServices->GetMemoryMap ( &mmapSize,
                                                     mmap,
