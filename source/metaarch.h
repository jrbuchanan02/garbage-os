...
// and debug. EVIL architectures might be the only place where the compiler
// could theoretically, possibly, maybe, have a chance of being the source of a
// bug. GOS also shouldn't show too many disassemblies of EVIL assembly
// instructions.
// 7. ENDIAN: 1 for little endian (most architectures are), 0 for BIG endian. if
// an architecture is bi-endian, GOS will note LITTLE endian to keep the
// binaries in GOS consistent.
    ...
    #define SIZE_BITS                                                          \
        32 // definition of size_t states that it can span entire address space.
    #define FLAT   0
    #define EVIL   1
    #define ENDIAN 1
