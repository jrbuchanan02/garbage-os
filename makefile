...
_C_FLAGS := -ffreestanding -mno-red-zone -Wall -Wextra -Wpedantic -Werror -O3 -g -c -I /usr/include/efi -I /usr/include/efi/x86_64/ -I /usr/include/efi/protocol -mtune=generic
